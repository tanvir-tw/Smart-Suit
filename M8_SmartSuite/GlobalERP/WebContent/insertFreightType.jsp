...
try
	{
		...
		String compQuery="insert into "+session.getAttribute("CompanyMasterID").toString()+"freightMaster (frtType, description, EntryBy,status) values (?,?,?,?)";
		...
		response.sendRedirect("alertGoTo.jsp?msg=New Freight Type Added Successfully&goto=freightMaster.jsp");
		}
}
catch(Exception e)
{
