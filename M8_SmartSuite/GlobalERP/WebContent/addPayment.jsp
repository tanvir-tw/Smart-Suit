...
<%} %>
 ...
 <input type="text" name="availBal" id="availBal" style="border: none;" value="0" readonly="readonly"></input>
		...
		<td>
		<input type="text" name="deductionValue" value="" id="deductionValue" style="width: 180px;
	border: 1px solid black;font: normal 11px Arial, Helvetica, sans-serif;color: #000000; " />
		</td>
		<!-- <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		Other Deduction:&nbsp;&nbsp;&nbsp;
	<input type="text" name="deductionValue" value="" id="deductionValue" style="width: 80px;
	border: 1px solid black;font: normal 11px Arial, Helvetica, sans-serif;color: #000000; " />
		</td> -->
	</tr>
