...
System.out.println("\n>>>>>$$$$$$$$$$$$$>>>In AjaxCategoryDelete.jsp>>>>>>>>>>>>>>>>"+con1);	
...
for(int i=1;i<arr.length;i++)
	{
		System.out.println("arr val"+arr[i]);
		SqlUpdate="UPDATE "+session.getAttribute("CompanyMasterID").toString()+"netbankingcategory SET Status ='Deactivate' WHERE ID='"+arr[i]+"' limit 1 ";
...
System.out.println("AjaxCategoryDelete.jsp error  table > "+e);
out.println("NO");
} finally {
	con1.close();
