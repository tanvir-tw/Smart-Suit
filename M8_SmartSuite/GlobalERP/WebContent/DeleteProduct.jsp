...
try
	{
		...
		String compQuery="UPDATE "+session.getAttribute("CompanyMasterID").toString()+"productMaster SET Status ='Deactivate' WHERE srno='"+srno+"' ";
		java.sql.PreparedStatement stmt = con.prepareStatement( compQuery );
		System.out.println("Query"+compQuery);
		stmt.executeUpdate(); 
		response.sendRedirect("alertGoTo.jsp?msg=Product De-activated Successfully&goto=productMaster.jsp");
