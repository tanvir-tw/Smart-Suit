...
{ %>
	...
	<li><a href="SendmailReport.jsp">Send Email Reports</a></li>
         					...
         					<li><a href="#">Task Index Report</a>
         					
         					<ul>
         					
         					                       
		           									
<li><a href="TaskIndexCalculation.jsp">Index Report</a></li>
<li><a href="KRACalculation.jsp">KRA Index Report</a></li>
<li><a href="TaskApprovalReport.jsp">Task Status Report </a></li>
<li><a href="KRATaskStatusReport.jsp">KRA Task Status Report </a></li> 
													...
													<%
		           									...
		           									{
		           									%>
		           									<li><a href="TaskAllocationReport.jsp">Task Allocation Report </a></li>
		           									<%} %>
...
<%if((session.getAttribute("EmpName").toString().equals("Washim") || session.getAttribute("EmpName").toString().equals("Aniket patil") ))
	{%>
...
<% } %>	 
           		       		...
           		       		<li><a href="#">Employee Score Report</a>
         					<ul>
         					                       ...
         					                       <li><a href="ViewScores.jsp">View Emp Scores</a></li>
		           									...
		           									{
		           										%>
		           										 <li><a href="ScoreCardReport.jsp">Emp Score Card</a></li>
		           										<%
		           									}
...
{ */
	...
	<li><a href="AttendanceReport.jsp">AttendanceReport</a></li>
	<li><a href="HolidayMaster1.jsp">HolidayMaster</a></li>
	<li><a href="PaidaysReport.jsp">PayrollDaysStatus</a></li>
	<% 
	...
	<li><a href="PayRollReport2.jsp">PayRoll Generation</a></li>
	<%} %>
	<li><a href="FinalPayReport.jsp">FinalPay Report</a></li>
...
<%}%>
					<li><a href='#'>Claims</a>
      					<ul>
         					...
         					<li><a href="AdvanceClaimReport.jsp">AdvanceReport</a></li>
						<%if(PurchaseAdmin.equalsIgnoreCase("Yes") || SalesAdmin.equalsIgnoreCase("Yes") || ClaimAdmin.equalsIgnoreCase("Yes") || AccountAdmin.equalsIgnoreCase("Yes") || CollectionAdmin.equalsIgnoreCase("Yes")){ %>
							...
							<li><a href="#">Reports</a>
   								<ul>
    								...
    								<li><a href="netbankreport.jsp">Net Banking</a></li>
         							...
         							<li><a href="InvoiceDetailsReport.jsp">InvoiceGSTDetail</a></li>
   								</ul>
							</li>
...
<!--        		  		<li><a href="collection.jsp">Collection</a></li> -->
   			...
   			<li><a href='#'>Reports</a>
   				...
   				<li><a	href="CustomerMaster1.jsp">CustomerMaster</a></li>
   				<%
     		...
     		<%}
   				if(Sales.equalsIgnoreCase("Yes") || SalesAdmin.equalsIgnoreCase("Yes") || Purchase.equalsIgnoreCase("Yes") || PurchaseAdmin.equalsIgnoreCase("Yes")){ %>
              		...
              		<li><a href="salesEnqReport.jsp?id=">Sales Enquiry</a></li>
               		...
               		<li><a href="billingDetails.jsp?companyCode=null">Billing Profile</a></li>
