...
<font size="3"><b> <%=name %>'s Assigned Customer Details</b></font></td></tr>
<tr></tr>
</table>
<br><br><br>
...
<iframe id="myIframe" width="100%" height="500px" src="http://<%= host1 %>:8080/birt/frameset?__report=AssignedCustomersDetail.rptdesign&CompanyId=<%=companyid %>&name=<%=name %>&allocationid=<%=allocationid %>&__showtitle=false">
