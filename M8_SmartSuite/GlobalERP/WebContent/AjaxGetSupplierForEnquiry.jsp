...
company=company.replace("_","");
  //sql1="SELECT *  from t_supplierdet where SupplierName like ('%"+company+"%') order by SupplierName limit 20 ";
 ...
 String buffer="<div style='height:120px;width:250px;overflow:auto; '><table style='background-color:white; width:400px; display: block';>";
 int i=1;
    ...
    rs1.beforeFirst();
	 ...
	 //while(rs1.next())
	   do{
	     ...
	     buffer+="<tr><td><font size=2><a href='#' onClick='showSelectedSuppliers(\""+rs1.getString("SupplierCode")+"\",\""+rs1.getString("SupplierName")+"\");'  style='color: black;'>"+rs1.getString("SupplierName").replaceAll("(?i)"+company,"<font color=blue><u>"+company.toUpperCase()+"</u></font>")+".</a></tr></font></td>";
