...
//Identifying  Sub Total
     ...
     System.out.println("1=>"+sqlsubtot);
...
//Identifying Invoice Type
	 String sqlinvtype="select  *  from "+session.getAttribute("CompanyMasterID").toString()+"salesinv_items where InvoiceNo="+mInvoiceno+"  and  itemdescription in ('Basic ST 15%')";
     ResultSet rsinvtype=st2.executeQuery(sqlinvtype);
     System.out.println("2=>"+sqlinvtype);
	 if(rsinvtype.next()) 
	 {
	   mInvtype="invst";
     }
	 ...
	 String sqlinvtype1="select  *  from "+session.getAttribute("CompanyMasterID").toString()+"salesinv_items where InvoiceNo="+mInvoiceno+"  and  itemdescription in ('Service Charge 15%')";
     ResultSet rsinvtype1=st3.executeQuery(sqlinvtype1);
	 if(rsinvtype1.next()) 
	 {
		mInvtype="invsc" ;
	 }
	 System.out.println("pppppppppppppppppppppppppppppp     "+sqlinvtype1);
...
//	if mDiscountamount
	...
	if (mInvtype=="invsc")
	{
		System.out.println("nGrandTotal=>"+nGrandTotal+"nTotal=>"+nTotal+"tpservicechargeamount=>"+tpservicechargeamount);
