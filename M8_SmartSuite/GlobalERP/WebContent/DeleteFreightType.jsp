...
try
	{
		...
		String compQuery="UPDATE "+session.getAttribute("CompanyMasterID").toString()+"freightMaster SET Status ='Deactivate' WHERE srno='"+srno+"' ";
		java.sql.PreparedStatement stmt = con.prepareStatement( compQuery );
		System.out.println("Query"+compQuery);
		stmt.executeUpdate(); 
		response.sendRedirect("alertGoTo.jsp?msg=Freight Type De-activated Successfully&goto=freightMaster.jsp");
