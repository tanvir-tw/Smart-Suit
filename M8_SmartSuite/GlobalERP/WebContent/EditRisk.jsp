...
<%@page import="java.util.Date"%>
	...
	{
			var risk=document.addBranch.risk.value;
			if(risk=="")
			{
				alert("Please Enter Risk Involved");
				return false;
			}
 ...
 %> <%
		...
		String Query="Select * from "+session.getAttribute("CompanyMasterID").toString()+"riskInvolvedMaster where srno='"+srno+"'";
		 ResultSet rs = st.executeQuery(Query);
		while(rs.next())	
		{
			risk=rs.getString("riskInvolved");
			description=rs.getString("description");
			
		}
 %> 
<form name="addBranch" method="post" action="insertEditRisk.jsp?Id=<%=srno%>" onsubmit="return ValidateForm();">
		<div align="center"><font face="Arial" color="black" size="3"><b>Edit Existing Risk</b></font></div>
		<br><br>
		<table align="center">
			<tr>
				<td>
						<font face="Arial" size="2" color="black"><b>Risk Involved</b></font>&nbsp;&nbsp;<font size="2" color="red">*</font>
				</td>
				<td>
						<input type="text" name="risk" id="risk" value="<%=risk %>" onblur="return validateBranchName();" style="width: 300px;" />
				</td>
			</tr>
