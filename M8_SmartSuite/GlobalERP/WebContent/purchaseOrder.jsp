...
<div class="content-header-col-md-7-mt-10 col-12">
    <div class="row breadcrumbs-top">
          <h5 class="content-header-title text-center mb-0" style="color: #060637">Generate Purchase Order from Purchase Quotation</h5>
    </div>
...
<thead>       
	...
	<tbody>
<%	
	String sqlEnq="",supcode="",Suppliercode="",PurQuoNo="",TWRefNo="",PurQuoDate="";
	

	sqlEnq="SELECT * FROM "+session.getAttribute("CompanyMasterID").toString()+"purchasequo as a LEFT OUTER JOIN "+session.getAttribute("CompanyMasterID").toString()+"pquo_items as b ON(a.PurQuoNo =b.PQNo) WHERE a.POGenerated=0 and a.PurQuoDate BETWEEN '"+dttime+"' and '"+dt1time+"' GROUP BY a.PurQuoNo, a.PurQuoDate, a.TWRefNo ";
	
	System.out.println("sqlEnq "+sqlEnq);			
	...
	PurQuoNo = rsEnq.getString("PurQuoNo");
	TWRefNo = rsEnq.getString("TWRefNo");
	PurQuoDate = rsEnq.getString("PurQuoDate");
	...
	System.out.println("sqlSup "+sqlSup);
...
%>  
	...
	<tr>
		...
		<td class="text-center">
			<a href="#" onclick="popUp('showOrderDet.jsp','<%=Suppliercode%>','<%=PurQuoNo%>','<%=TWRefNo%>'); return false;">
    <%=PurQuoNo%>
</a> </td>
					...
					buttons : [
							{
	                         ...
	                         title: 'Purchase Order from Purchase Quotation '+$("#data").val()+ ' to ' +$("#data1").val(),
							},
							{
							 extend: 'pdfHtml5',
