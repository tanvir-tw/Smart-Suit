...
function Redirect()
{
	    ...
	    location.assign("TaskDetailsReport.jsp?userId="+userId+"&fromdate="+dd+"&todate="+dd1+"&HOD="+HOD+"&Dept="+Dept+"&User="+Usern+"&Status="+Status+"&Role="+Role);
...
System.out.println("Connection done.................. in KRANextAdd.jsp page");
