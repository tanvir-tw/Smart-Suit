...
try
	{
		...
		String compQuery="UPDATE "+session.getAttribute("CompanyMasterID").toString()+"loadTypeMaster SET Status ='Deactivate' WHERE srno='"+srno+"' ";
		java.sql.PreparedStatement stmt = con.prepareStatement( compQuery );
		System.out.println("Query"+compQuery);
		stmt.executeUpdate(); 
		response.sendRedirect("alertGoTo.jsp?msg=Load Type De-activated Successfully&goto=loadTypeMaster.jsp");
