...
<head>
 ...
 <body ONKEYDOWN="if (event.keyCode == 27){document.getElementById('companyList').style.display = 'none';}" style="background-color:azure;" >
...
<div class="content-header-col-md-7-mt-10 col-12">
	...
	%> 
		<table id="example" class="display" style="width:100%;">
			...
			<tbody>
	<%
	String Sql="Select * from "+session.getAttribute("CompanyMasterID").toString()+"paymentEntryDet where EntryDate  between '"+dt+"' AND '"+dt1+"'  And 	PaymentRequestedby='"+session.getAttribute("EmpName")+"' order by EntryDate ";
					...
					buttons : [
							{
	                         ...
	                         className: 'dropdown-item',  
								title: 'All Payment Report from '+$("#data").val()+ 'to' +$("#data1").val(),
							},
							{
							 extend: 'pdfHtml5',
