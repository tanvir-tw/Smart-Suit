...
<form name="editCustomer" method="post" action="addCustomer.jsp?update=true&companyName=<%=rs1.getString("CompanyName") %>&CustomerCode=<%=rs1.getString("CustomerCode") %>"
	...
	<table border="0" cellpadding="3" width="75%"
		...
		<tr>
			...
			<readonly="readonly"><%=rs1.getString("CompanyName") %></input>
			</div>
			</td>
