...
file_name="NCPL"+s+(y+1900)+"_"+h+mi+ss+".xml";
System.out.println("======================================================");
System.out.println("CreateXML page NCPL");
...
<%
String file_move1=request.getParameter("filename1");
System.out.println("File1 "+request.getParameter("filename1"));

String z=file_move1+"@"+file_name;
System.out.println("File Move "+z);
response.sendRedirect("XMLCompleted.jsp?filename="+z+"@");
%>