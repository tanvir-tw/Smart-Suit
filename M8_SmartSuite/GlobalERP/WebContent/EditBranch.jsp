...
try
	{
		...
		String compQuery="update "+session.getAttribute("CompanyMasterID").toString()+"BranchMaster set BranchName=?, Address=?, Location=?, Phone=?, EntryBy=?  where srno='"+ srno+"'";
		...
		response.sendRedirect("alertGoTo.jsp?msg=Branch Updated successfully&goto=BranchMaster.jsp");
