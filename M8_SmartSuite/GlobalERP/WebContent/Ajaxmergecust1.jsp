...
int counter=0;
  ...
  if(newstring.toLowerCase().contains(company.toLowerCase()))
	  ...
	  buffer+="<tr><td><a href='#' onClick='getCustomerDetails1("+i+");'  style='color: black;'>"+rs1.getString("a").replaceAll("(?i)"+company,"<font color=blue><u>"+company.toUpperCase()+"</u></font>")+"->"+rs1.getString("contactperson").replaceAll("(?i)"+company,"<font color=blue><u>"+company.toUpperCase()+"</u></font>")+"->"+rs1.getString("BranchName").replaceAll("(?i)"+company,"<font color=blue><u>"+company.toUpperCase()+"</u></font>")+".</a></tr></td>";
 
  	else if(rs1.getString("ContactPerson").toLowerCase().contains(company.toLowerCase()))
  	{
  		System.out.println("^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^");
  		buffer+="<tr><td><a href='#' onClick='getCustomerDetails1("+i+");'  style='color: black;'>"+rs1.getString("ContactPerson").replaceAll("(?i)"+company,"<font color=blue><u>"+company.toUpperCase()+"</u></font>")+"->"+rs1.getString("BranchName").replaceAll("(?i)"+company,"<font color=blue><u>"+company.toUpperCase()+"</u></font>")+"-> <u>"+newstring+"</u>.</a></tr></td>";

  	}
  	 else if(rs1.getString("MobileNo").contains(company))
   	 buffer+="<tr><td align='left'><a href='#' onClick='getCustomerDetails1("+i+");' style='color: black;'>"+rs1.getString("MobileNo").replaceAll("(?i)"+company,"<font color=blue><u>"+company.toUpperCase()+"</u></font>")+"->"+rs1.getString("BranchName").replaceAll("(?i)"+company,"<font color=blue><u>"+company.toUpperCase()+"</u></font>")+"-> <u>"+rs1.getString("CompanyName")+".</u></a></tr></td>";
