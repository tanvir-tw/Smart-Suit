...
String Buffer="";
String buffer="<div  id='userid' style='height:80px;width:200px;'><table width='150px' align = 'left' style='background-color:lightblue;''>";
...
{
	sql1="(SELECT EmpName from "+session.getAttribute("CompanyMasterID").toString()+"security where EmpName like ('%"+Empname+"%') order by EmpName limit 10 )";
...
{
	String select="select * from "+session.getAttribute("CompanyMasterID").toString()+"security where EmpName='"+Empname+"' limit 10";
