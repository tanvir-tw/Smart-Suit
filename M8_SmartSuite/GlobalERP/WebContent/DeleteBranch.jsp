...
try
	{
		...
		String compQuery="DELETE FROM "+session.getAttribute("CompanyMasterID").toString()+"BranchMaster where srno='"+srno+"'";
		java.sql.PreparedStatement stmt = con.prepareStatement( compQuery );
		System.out.println("Query"+compQuery);
		stmt.executeUpdate(); 
		response.sendRedirect("alertGoTo.jsp?msg=Branch Deleted successfully&goto=BranchMaster.jsp");
