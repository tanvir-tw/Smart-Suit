...
if(save!=null)
{
	...
	try{
	window.location="addOpportunity.jsp?companyName="+request.getParameter("companyname").replace("...","&");
	}catch(e)
	{
		//alert(e);
	}
	...
	<table  cellpadding="" align="center" border="0" width="90%" style="background: ">
		<tr>
			...
			<input type="text" name="companyName" style="width: 350px;"  id="companyName" value="<%=companyname%>" readonly="readonly"/>
