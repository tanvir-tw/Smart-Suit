...
location.assign("TaskDetReport.jsp?userId="+userId+"&fromdate="+dd+"&todate="+dd1+"&HOD="+HOD+"&Dept="+Dept+"&User="+Usern+"&Status="+Status+"&Role="+Role+"&itemName2="+itemName2+"");
...
String tast_project ="",task_name="",task_duration="",task_creator="";
...
if(rs.next())
     {
	   tast_project = rs.getString("task_project");
     ...
     try
     {
	   String sql4 = "select * from db_GlobalERP.UserMaster where dotprojectid='"+user_id+"'";
 ...
 String checkm="select * from db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"taskmaildata where TaskID='"+TaskID1+"' order by MailDateTime desc ";
  ...
  //System.out.println("RSCHECKM1 IS------->>" + checkm);
   ...
   String updatestatus1="update db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"taskmaildata set TaskStatus='"+updatestatus+"',TaskPercent='"+other123+"', TaskComment='"+comment1+"',TaskAttachment='"+itemName2+"' where TaskID='"+TaskID1+"' and MailDateTime='"+MailDateTime+"' ";
 	...
 	System.out.println("update Musarrat Login -->"+updatestatus1);

 stmt5.executeUpdate(updatestatus1);
 	out.println("<script>  Redirect();</script>");
 	
 	String updatestatus2="update dotproject.tasks  set task_project='"+ProjectID+"' where task_id='"+TaskID1+"' and task_project='"+tast_project+"'";
 	System.out.println("update Musarrat Login -->update flag true : "+updatestatus2);

 	stmt6.executeUpdate(updatestatus2);
 	out.println("<script>  Redirect();</script>");
...
stmt5.executeUpdate(InsertData);
  //   System.out.println("After Execution Sql-->"+InsertData);
  	...
  	String updatestatus2="update dotproject.tasks  set task_project='"+ProjectID+"' where task_id='"+TaskID1+"' and task_project='"+tast_project+"'";
  	System.out.println("update Musarrat Login -->update flag false : "+updatestatus2);
...
stmt5.executeUpdate(InsertData);
 // System.out.println("After Execution Sql-->"+InsertData);
	...
	/*  	String updatestatus2="update dotproject.tasks  set task_project='"+ProjectID+"' where task_id='"+TaskID1+"' and task_project='"+tast_project+"'";
	 	System.out.println("update Musarrat Login -->update flag both true : "+updatestatus2);
