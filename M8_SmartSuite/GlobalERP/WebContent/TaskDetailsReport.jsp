...
System.out.println("department-->"+department);
        ...
        {
		query12="select b.UserID as UserId,c.EmpName as User,a.task_id as TaskId,a.task_name as TaskName,a.task_description as TaskDescription,a.task_duration as Duration,b.TaskPercent as TaskPercent,b.TaskComment as TaskComment,b.TaskAttachment as TaskAttachment,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate,b.TaskStatus as Status,b.TaskRejectionComment  from dotproject.tasks a join db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"taskmaildata  b  on a.task_id=b.TaskID left join db_GlobalERP.UserMaster c on b.UserId=c.KRAdotprojectid where  b.userid in (select KRAdotprojectid from db_GlobalERP.UserMaster where empname like '%"+name13+"%' and companymasterid='"+session.getAttribute("CompanyMasterID").toString()+"' and activestatus='Yes'  and dept like '%"+department+"%')  and  a.task_start_date >='"+dt+"' and a.task_end_date <='"+dt1+"' and c.companymasterid='"+session.getAttribute("CompanyMasterID").toString()+"' and c.activestatus='Yes' and b.TaskStatus like '%"+Status+"%'  and dept like '%"+department+"%' order by b.taskid";	    
        	System.out.println("query12---"+query12);
			rs=stmt.executeQuery(query12);			
			int i=1;			
			while(rs.next())
			{			
				...
				TaskPercent=rs.getString("TaskPercent");				
				TaskComment=rs.getString("TaskComment");				
				RejectionComment=rs.getString("TaskRejectionComment");			
			%>
			<tr>
						<td class="text-center"><%=i%></td>
						<td class="text-left"><%=User%></td>		
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {
		query12="select b.UserID as UserId,c.EmpName as User,a.task_id as TaskId,a.task_name as TaskName,a.task_description,b.TaskAttachment as TaskAttachment,a.task_duration as Duration,b.TaskPercent as TaskPercent,b.TaskComment as TaskComment,date_format(a.task_start_date,'%d-%b-%Y %T' ) as StartDate,date_format(a.task_end_date,'%d-%b-%Y %T') as EndDate,b.TaskStatus as Status,b.TaskRejectionComment  from dotproject.tasks a join db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"taskmaildata  b  on a.task_id=b.TaskID left join db_GlobalERP.UserMaster c on b.UserId=c.KRAdotprojectid where  b.userid in (select KRAdotprojectid from db_GlobalERP.UserMaster where empname like '%"+name13+"%' and companymasterid='"+session.getAttribute("CompanyMasterID").toString()+"' and activestatus='Yes'  and dept like '%"+department+"%')  and  a.task_start_date >='"+dt+"' and a.task_end_date <='"+dt1+"' and c.companymasterid='"+session.getAttribute("CompanyMasterID").toString()+"' and c.activestatus='Yes' and b.TaskStatus like '%"+Status+"%'  and dept like '%"+department+"%' order by b.taskid";     
    	System.out.println("query12---"+query12);
		rs=stmt.executeQuery(query12);	
		int i=1;	
		while(rs.next())
