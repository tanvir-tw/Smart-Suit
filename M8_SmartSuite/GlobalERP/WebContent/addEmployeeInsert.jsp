...
CallableStatement cs=(CallableStatement) conn.prepareCall("{call DailyReportData.Add_contractor_report ('"+empid+"','"+cName+"','"+username+"','"+email+"' ,'"+pass+"' ,'"+confirm+"','"+typeOfUser+"','"+deptName+"')}");
...
/*  code for updating reporting to hod for all User in that Department */
	...
	try
	{
		...
		System.out.println("sqledit====== added jul 2022 "+sqledit);
		
		st16.executeUpdate(sqledit);
		...
		System.out.println("sqlInsertHistory  added jul 2022 "+sqlInsertHistory); 
