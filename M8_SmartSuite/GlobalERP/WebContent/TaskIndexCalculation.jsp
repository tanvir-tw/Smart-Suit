...
<%
String dept = "",Sesrole1="",sessiondept="",user_id1 = "";
...
Statement st = null,st1 = null,stt = null,sta = null, stb = null,stc = null,std = null,st_up = null,st_up1 = null;
Statement st_user_id = null,st2 = null,st3 = null,st4 = null,st5 = null, st6 = null,st7 = null, st8 = null;
try {
...
<div class="content-header-col-md-7-mt-10 col-12"> 
  ...
  <form name="formreport" id="formreport" method="get"  onsubmit="return confirmSubmit()" action="">
...
ResultSet rs1=st1.executeQuery(toDate1);
rs1.next();
String mnth3=rs1.getString("monthname3");
toDate=mnth3;
...
while(rs.next()) {
		...
		String user_name = rs.getString("user_username");
				...
				// System.out.println("The query ==>>"+sql_total);
				...
				while(rstotdays.next()){
					...
					//String totdays1="select WorkingDays as days from db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"WorkingDayMaster where month='"+mnth+"' and Year='"+rsyear.getString("year")+"' ";
						 ...
						 if(leaveday > 1)
							{
								for(int i=0;i<leaveday;i++)
								{
									...
									System.out.println("Date Format   2 :-"+dt2);
				...
				System.out.println("The per_index is ==>>"+c_cat_per+" "+a_cat_per+" "+b_cat_per);
				String todaysDate1 = new SimpleDateFormat("yyyy-MM-dd").format(new java.util.Date());
	            System.out.println("a_cat_per is" + a_cat_per + b_cat_per + c_cat_per +  d_cat_per);
