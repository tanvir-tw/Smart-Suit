...
PdfGeneration  pdf =new PdfGeneration(Com,EMP_FullName,user);
...
for(int i=1;i<arr.length;i++)
	{
		...
		System.out.println("arr val"+arr1[i]);
		
		
		
	//	 System.out.println("path==========>>"+(config.getServletContext().getRealPath("/")).toString());
		
		 pdf.PdfGenerationCustomeCode(year,month,arr[i],arr1[i],session.getAttribute("CompanyMasterID").toString(), EMP_FullName, user);
