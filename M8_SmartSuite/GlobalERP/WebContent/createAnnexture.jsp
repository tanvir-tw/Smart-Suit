...
para5.add(new Paragraph("Amount per vehicle="+flratepervehicle+"   ",headerFont));
...
para7.add(new Paragraph("Amount For 1 Day ="+flratepervehicle/daysinmonth+"   ",headerFont));
...
para13.add(new Paragraph("Total Amount= ("+flratepervehicle+"/"+daysinmonth+") * "+totaldays+" = "+ (flratepervehicle/daysinmonth) * totaldays+"  ",headerFont));
...
{	
   ...
   para14.add(new Paragraph("JRM - Monthly Road Risk Data Flat Charges = "+ jrmcount*100+"  ",headerFont));
...
{
	Paragraph para14=new Paragraph();
	para14.add(new Paragraph("JRM - Monthly Road Risk Data Flat Charges = Not Applicable"+"  ",headerFont));
	para14.setAlignment("Left");
	document.add(para14);	
}
...
para15.add(new Paragraph("Net Bill Amount = "+ nba+"  ",headerFont));
para15.setAlignment("Left");
document.add(para15);


Paragraph para16=new Paragraph();
para16.add(new Paragraph("Invoice Amount = Net Bill Amt * 12.36 Service Charge = "+ (nba+(12.36/100)*nba)+" ",headerFont));
