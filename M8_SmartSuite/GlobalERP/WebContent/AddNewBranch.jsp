...
<%@page import="java.util.Date"%>
 ...
 %> <%
		...
		try {
			...
			{}
 %> 
<form name="addBranch" method="post" action="addBranch.jsp" onsubmit="return ValidateForm();">
		<div align="center"><font face="Arial" color="black" size="3"><b>Add New Branch</b></font></div>
		<br><br>
		<table align="center">
			<tr>
				<td>
				...
				<td>
						<input type="text" name="BranchName" id="BranchName" onblur="return validateBranchName();" style="width: 300px;" />
				</td>
			</tr>
			<tr><td></td></tr>
			<tr>
				...
				<td>
						<textarea name="address" id="address" onblur="return validateaddress();" style="width: 300px;"></textarea>
				</td>
			</tr>
			<tr><td></td></tr>
			<tr>
				...
				<td>
						<input type="text" name="Location" id="Location" onblur="return validateLocation();" style="width: 300px;"  />
				</td>
			</tr>
			<tr><td></td></tr>
			<tr>
				...
				<td>
						<input type="text" name="PhoneNumber" id ="PhoneNumber"  onblur="return validatePhoneNumber();" style="width: 300px;"  id="PhoneNumber" />
				</td>
			</tr>
		</table>
