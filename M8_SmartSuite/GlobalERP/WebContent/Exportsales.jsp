...
<form name='ledgerDetails' action="addExportSalesEnq1.jsp" onsubmit="return validate();" method="post" autocomplete="off">
  ...
  <div class="card-body">
      ...
      <div class="col-4 mt-4">
        <div class="input-container">
       		<input class="form-control floating-input" type="text" id="companyNames" name="companyNames" onkeyup="getCompanies()" autocomplete="off" placeholder=""/>
...
<%
   ...
   <td class="text-left"><%=rs.getInt("srno") %></td>
   <td class="text-left"><%=rs.getString("TheGroup") %></td>
   <td class="text-left"><%=rs.getString("make") %></td>
   <td class="text-left"><%=rs.getString("model") %></td>
   <td class="text-left"><%=rs.getString("partno") %></td>
   <td class="text-left"><%=rs.getString("description") %></td>
   <td class="text-left"><%=rs.getString("quantity") %></td>
...
<div style="margin-left: 81%; width: 125px;">
  <b>Generate Quotation</b><br>
  <a href="salesenq.jsp" style="font-weight: bold; color: black; text-decoration: none;">
    <img src="images/arrow_right.png" width="42" height="42" style="border-style: none;" alt="Right Arrow">
  </a>
</div>
