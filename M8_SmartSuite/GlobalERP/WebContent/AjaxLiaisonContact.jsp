		...
		String type=request.getParameter("Type");
		 String maddress="";
	        ...
	        while(rs1.next())
	        {
	        	...
	        	CustCategory=rs1.getString("CustCategory");
	        }
	        ...
	        if( comptype.equals("Customer"))
	        {
	           ...
	           sql="SELECT DISTINCT(contactperson) as Contact from "+session.getAttribute("CompanyMasterID").toString()+"contactdet where salesCustomerCode='"+type12+"' AND mobileno <> 'null' ";				
	           System.out.println("customer query----111>>"+sql);
	        }
	        else
	        {
	        	System.out.println("In Prospests Details");
	        	sql="SELECT DISTINCT(contactperson) as Contact from "+session.getAttribute("CompanyMasterID").toString()+"contactdet where customercode='"+Code+"' AND mobileno <> 'null'";				
	           System.out.println("customer query----111>>"+sql);
	        }
