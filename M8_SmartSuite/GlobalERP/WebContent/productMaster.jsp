...
{
	var agree=confirm("Do You Want To De-activate Product?");
		if (agree)
			return true ;
		else
			return false ;
...
{
	var agree=confirm("Do You Want To Edit Product?");
	if (agree)
		return true ;
	else
		return false ;	
...
<div align="center"><table  align="center" style="width: 70%;"><tr><td align="center" colspan="4"><a align="center" style="font-size:1.6em"><b>Product Master Report</b></a></td></tr></table></div>

<div><table width ="100%" border="0"><tr align="left"><td><a href="AddNewProduct.jsp"><b>Add New</b></a></td>	</tr></table></div>
<iframe src="http://twtech.in:8080/birt/frameset?__report=ProductMasterRPT.rptdesign&__showtitle=false" width="100%" height="70%">
</iframe>
</body>
</html>
</jsp:useBean>
