...
//document.addOpportunity.city.style.visibility="visible";
	...
	function add2()
	{
     ...
     // alert("Type hiiiiiiiiiiiiiiiiiii:-"+Type)\
     		...
     		//alert("5"+type);
     		//var url="contactdetails.jsp?companyname='Test'&customercode='2'&Type='3'&isclose=true";
     		var url="addcontact.jsp?companyname="+customername+"&isclose=true ";
     		var win = window.open(url,'_blank');
                  	  	win.focus();
...
function validate()
{
	...
	if(OppBranch==" " || BillBranch==" " || Consignor==" " || Consignee==" " || Ldtype==" " || frtype==" ")
	{
...
{
	//alert("111-----");
	var customername=document.getElementById("Company1").value;
	...
	ajaxRequest.onreadystatechange = function()
	{
		...
		{//alert("######################### ");
		   ...
		   //alert("Original result"+reselt);
			//var finalres=reselt.split("#"); 	
			document.getElementById("collectionstaff").innerHTML=reselt;
			//alert("After trim"+reselt);
			document.getElementById("my1").value=finalres[1]; //comtype
			//alert("After trim Company Type----"+finalres[1]);
			document.getElementById("my2").value=finalres[2]; //comname
	...
	var queryString = "?customername="+customername;
     //alert("Query String ---"+queryString);
	ajaxRequest.open("GET", "AjaxEditOpportunityCollectionStaff.jsp"+queryString, true);
	ajaxRequest.send(null); 
	...
	<%
		...
		Statement st = null, st1 = null, st3 = null, st4 = null,st5=null,st6=null,st7=null,st8=null,stid=null,st9=null,st10=null,st11=null,st12=null;
		Statement st2 = null;
		String selectedName;
		...
		companynaw=companynaw.replace("and","&");
...
%>
 <input type="hidden" name="Comapny" id="companyName" value="Company" />
<% 
...
System.out.println("User Level is-->"+session.getAttribute("userLevel").toString());
String customer="";
...
if(save!=null)
{
	...
	try{
	window.location="addOpportunityNew.jsp?companyName="+request.getParameter("companyName");
	}catch(e)
	{
		//alert(e);
	}
	...
	<div>
	 <div style="height:27;width:100%;"> 
            ...
            <tr>
            	...
            	<td align="center" colspan="3"><font face="Arial" color="black" size="3"><b>
							
						Edit Opportunity</b></font><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br></br>
	<%String sqlid="SELECT * FROM "+session.getAttribute("CompanyMasterID").toString()+"opportunitymaster where srno='"+id+"'";
	ResultSet rsid=stid.executeQuery(sqlid);
	while(rsid.next()){
		
	 %>
	<form name="addOpportunity" method="post" action="InsertOpportunityNew.jsp?update=update&Id=<%=id %>"  onsubmit="return validate();" >
	
	<table  cellpadding="1"   border="0" width="90%" style="background: ">
	
		<tr>
			<td></td><td></td><td></td><td></td>
			<td>
			<b><font face="Arial" size="2" color="black">Customer Name:</font></b> 
			</td>
			<td>
			<input type="text" name="custName" id=""  style="width: 235px; height:20px;" value="<%=rsid.getString("customer") %>" readonly="readonly"/>
	...
	<input type="hidden" id="customertype1" name="customertype1" value="<%=customertype%>" />   
			...
			<td></td><td></td><td></td>
			<td>
			<b><font face="Arial" size="2" color="black">Marketing Rep.Name :</font></b>
			...
			<td>
				<select
				  	...
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; "
						 >
					<option ><%=rsid.getString("markRep")%></option>
					<%
			...
			<tr>
			<td></td><td></td><td></td><td></td>
			<td><font face="Arial" size="2" color="black"><b>Opportunity Branch</b></font><font size="2" color="red">*</font></td>
			<td>
			
			<select name="branch" id="branch" style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; ">
				  	<option><%=rsid.getString("branchName") %></option>
				  <% String sqlDropdown11="SELECT Distinct branchName FROM "+session.getAttribute("CompanyMasterID").toString()+"BranchMaster where branchName not in ('NULL','') order by branchName ";
			...
			<select name="billbranch" id="billbranch" style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; ">
				  	<option><%=rsid.getString("billBranch") %></option>
...
<tr><td></td><td></td><td></td><td></td>
			<td><font face="Arial" size="2" color="black"><b>Consignor :</b></font><font size="2" color="red">*</font></td>
			
			<td>
			
			<select name="consigner" id="consigner" onchange="consig();" style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; ">
				  	<option><%=rsid.getString("consigner") %></option>
			...
			<select  name="consignee" id="consignee"  onchange="consig1();"style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; ">
				  	<option><%=rsid.getString("consignee") %></option>
...
<tr>
		<tr>
						  <td></td><td></td><td></td><td></td><th align="left" style=" width: 8.5%" ><font face="Arial" size="2" color="black"><b>ConsignorContact:</b></font></th>
...
<select  name="spokento123" id="spokento123"  style="
				  	...
				  	<option><%=rsid.getString("ConsignerContact") %></option>
				  	
				  <% //SELECT DISTINCT(contactperson) from "+session.getAttribute("CompanyMasterID").toString()+"contactdet where companyname='"+rsid.getString("consignee")+"'AND mobileno <> 'null' order by firstname,middlename,lastname
				  String sqlDropdownCCB="SELECT Distinct contactperson as Contact from "+session.getAttribute("CompanyMasterID").toString()+"contactdet where companyname='"+rsid.getString("consigner")+"' AND mobileno <> 'null'";
				  ResultSet rsDropdownCCB=st2.executeQuery(sqlDropdownCCB);
				  System.out.println("ConsignerContact-------------------"+sqlDropdownCCB);
				  while(rsDropdownCCB.next()){
				  %>
				     
				    <option value="<%=rsDropdownCCB.getString("Contact")%>"><%=rsDropdownCCB.getString("Contact")%></option>  
	...
	<%
	String Company1=request.getParameter("companyNames");
...
// 	String  companynaw=request.getParameter("companyNames");
// 	System.out.println("Company 1companyNamescompanyNamescompanyNames----------"+companynaw);
	
// 	String  customercode=request.getParameter("customercode");
// 	System.out.println("Company 1-customercodecustomercodecustomercode---------"+customercode);
// 	String  customertype=request.getParameter("customertype");
// 	System.out.println("Company customertypecustomertype 1----------"+Company1);
	%>
	<input type="hidden" name="Company1" id="Company1" value=<%=Company1%>/>
...
<!-- 			<a href="#" onclick="load(0)"> Refresh</a> -->
			...
			<td></td><td></td>
			<th align="left" style=" width: 8.5%" ><font face="Arial" size="2" color="black"><b>ConsigneeContact:</b></font></th>
							<td style="vertical-align: top;width: 5%" align="left">
<!-- 	<input type="text" class="input" name="spokento" id="spokento" value="" style="height: 15px; width:95%; padding: 4px 5px 2px 5px;  background: #FFFFFF font :normal 11px Arial, Helvetica, sans-serif; width: 75; max-width: 40;"> -->
<div id="refreshthis1">
...
<select  name="spokento12345" id="spokento12345"  style="
				  	...
				  	<option><%=rsid.getString("ConsigneeContact")%></option>
				  	<!-- <script>
					alert("Consignee Contact---"+rsid.getString("ConsigneeContact"));				  	
				  	</script> -->
				  	
				  	<%System.out.println("Consignee Contact*************"+rsid.getString("ConsigneeContact")); %>
<% //SELECT DISTINCT(contactperson) from "+session.getAttribute("CompanyMasterID").toString()+"contactdet where companyname='"+rsid.getString("consignee")+"'AND mobileno <> 'null' order by firstname,middlename,lastname
				  String sqlDropdownCCB2="SELECT Distinct contactperson as Contact from "+session.getAttribute("CompanyMasterID").toString()+"contactdet where companyname='"+rsid.getString("consignee")+"' AND mobileno <> 'null'";
				  ResultSet rsDropdownCCB2=st2.executeQuery(sqlDropdownCCB2);
				  System.out.println("ConsigneeContact--------------------"+sqlDropdownCCB2);
				  while(rsDropdownCCB2.next()){
				  %>
				  <%
				  System.out.println("Consignee Contact*******22222222222"+rsDropdownCCB2.getString("Contact"));
				  %>
				 
				    <option value="<%=rsDropdownCCB2.getString("Contact")%>"><%=rsDropdownCCB2.getString("Contact")%></option>   
...
<!-- 			<a href="#" onclick="load(0)"> Refresh</a> -->
			...
			<!-- <a href="#" style="font-weight: bold; color: blue;" onclick="addCon(1)"">Add Contact</a> -->
			<td><a href="#" style="font-weight: bold; color: blue;" onclick="add1()"> Add New</a></td>
...
<tr><td></td><td></td><td></td><td></td>
			...
			<select name="origin" id="origin" style="
				...
				<a href="#" style="font-weight: bold; color: blue;" id="f15" onclick="showentryform2()">Add New</a>
				   ...
				   <td></td><td></td><td  align="left"><font face="Arial" size="2" color="black"><b>Destination :</b></font></td>
			<td>
			
			<select name="dest" id="dest" style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; ">
				  	<option><%=rsid.getString("locationTo") %></option>
		...
		<tr>
			...
			<select name="loadType" id="loadType" style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; ">
				  	<option><%=rsid.getString("loadType") %></option>
		...
		<!--  	<a href="#" style="font-weight: bold; color: blue;" id="f19" onclick="showentryform4()">Add New</a> -->
			...
			<select name="frt" id="frt" style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; ">
				  	<option><%=rsid.getString("frttype") %></option>
		...
		<tr><td></td><td></td><td></td><td></td>
			<td  align="left" ><font face="Arial" size="2" color="black"><b>MonthlyVolume(Tons):</b></font></td>
			<td align="left">
			<input type="text" name="mvt" id="mvt" style="width: 235px; height:20px;" onblur="myFunction()" value="<%=rsid.getString("monthVal")%>"/>
			</td>
			<td></td><td></td><td></td>
			...
			<select name="product" id="product" style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; ">
				  	<option><%=rsid.getString("product")%></option>
		...
		<input type="text"  name="products" id="products" style="display: none"/>				<a href="#" style="font-weight: bold; color: blue;display: none " id="f22" onclick="showminus6('-')"><font  size="3" >(-)</font></a>
			...
			<td>
			<input type="text" name="load" id="load" style="
				  	width: 235px; height:20px;" value="<%=rsid.getString("loadRef")%>"/></td>
			
			<td></td><td></td><td></td>
			<td><font face="Arial" size="2" color="black"><b>ExistingTransporter: </b></font></td>
			<td>
			
			<select name="trans" id="trans" style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; ">
				  	<option><%=rsid.getString("existTrans")%></option>
		...
		<input type="text"  name="trans1" id="trans1" style="display: none"/>				<a href="#" style="font-weight: bold; color: blue;display: none " id="f26" onclick="showminus8('-')"><font  size="3" >(-)</font></a>
			...
			<tr>
			<td></td><td></td><td></td><td></td>
			<td><font face="Arial" size="2" color="black"><b>Valid From :</b></font></td>
			<td>
			
			<input type="text" id="fromdate"
name="fromdate"  value="<%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(rsid.getString("validFrom"))) %>"  size="15" readonly
...
button      : "fromdate"       // ID of the button
			...
			<td></td><td></td><td></td><td  align="left"><font face="Arial" size="2" color="black"><b>Valid To :</b></font></td>
			<td>
			
			<input type="text" id="todate"
name="todate" value="<%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(rsid.getString("validTo"))) %>" onchange="dateValidate();" size="15" readonly
style="width: 75px; padding: 4px 5px 2px 5px; border: 1px solid #DEDEDE; background: #FFFFFF; font: normal 11px Arial, Helvetica, sans-serif; background: #C6DEFF" />
<script type="text/javascript">
Calendar.setup(
{
...
button      : "todate"       // ID of the button
         ...
         <tr><td></td><td></td><td></td><td></td>
         <td><font face="Arial" size="2" color="black"><b>Risk Involved :</b></font></td>
			<td>
			
			<select name="risk" id="risk" style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; ">
				  	<option><%=rsid.getString("riskInvolved")%></option>
         ...
         <td></td><td></td><td></td>
         	<td><b><font face="Arial" size="2" color="black">CollectionStaff:</font></b></td>
		<td><select name="collectionstaff" id="collectionstaff" style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000;">
				<!-- <option value="Select">Select</option> -->
				<option value="<%=rsid.getString("ColloectionStaffName")%>"><%=rsid.getString("ColloectionStaffName")%></option>
				<% 
				  String sqlDropdownCCB1="SELECT Distinct name as Name FROM "+session.getAttribute("CompanyMasterID").toString()+"collectionStaffMaster order by name asc";
				  ResultSet rsDropdownCCB1=st2.executeQuery(sqlDropdownCCB1);
				  while(rsDropdownCCB1.next()){
				  %>
				    <option value="<%=rsDropdownCCB1.getString("Name")%>"><%=rsDropdownCCB1.getString("Name")%></option>   
...
<!-- <a style="font-weight: bold; color: blue;" onclick="collection()">Edit</a></td> -->	
...
<tr>
        ...
        <td></td><td></td><td></td><td></td>		
		<td>
			<font face="Arial" size="2" color="black"><b>Commission :</b></font></td>
			
			<td>
			<input type="text" name="comm" style="
				  	width: 235px; height:20px;" onblur="myFunction()"  value="<%=rsid.getString("commission")%>"/>
			</td>
			<td></td><td></td><td></td>
			<td><font face="Arial" size="2" color="black"><b>Remarks :</b></font></td>
			<td>
			<textarea id="remark" name="remark"  style="
				  	width: 235px; height:20px;"><%=rsid.getString("remark")%></textarea>
			</td>
		...
		<div><select name="Liaison" id="Liaison" onchange="liason1();" style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000; "">
				<!-- <option value="Select">Select</option> -->
					<option><%=rsid.getString("LiaisonOfficer") %></option>
				
				<% String sqlDropdown123="select * from "+session.getAttribute("CompanyMasterID").toString()+"prospectivecustmaster where CustCategory='Liaison' order by CompanyName asc " ;
...
<select  name="Liaison12345" id="Liaison12345" style="
				  	width: 235px; height:20px; border: 1px solid black; font: normal 11px Arial, Helvetica, sans-serif; color: #000000;" onclick="re(0)">
				  	<!-- <option value="Select">Select</option> -->
				  	<option><%=rsid.getString("LiaisonContact") %></option>
	<option></option>			  	
...
<%} %>
<tr>
			<td valign="bottom" align="center" colspan="17">
			<input type="submit" id="search-submit"
				name="submitFollowUp" value="Update" />
			</td>
		</tr>
	<tr>
	<td></td>
	...
	while(rsid.next()){
	 ...
	 %>
	<form name="addOpportunity" method="post" action="InsertOpportunityNew.jsp?update=update&Id=<%=id %>"  >
	...
	<table  cellpadding="" align="center" border="0" width="90%" style="background: ">
		<tr>
			...
			<td >
			<div id="custName"><input type="text" name="custName" id=""  value="<%=rsid.getString("customer") %>" readonly="readonly"/>
			</div>
			</td>
...
<tr>
		...
		<tr>
			...
			<td align="left">
			<input type="text" name="mvt" id="mvt" onblur="myFunction()" value="<%=rsid.getString("monthVal")%>"/>
			</td>
		...
		<td></td>
			...
			<td align="left">
			<input type="text" name="load" id="load" value="<%=rsid.getString("loadRef")%>"/>
			</td>
...
button      : "todate"       // ID of the button
 	...
 	<td><b><font face="Arial" size="2" color="black">Collection Staff</font></b></td>
		<td><select name="collectionstaff" id="collectionstaff" style="width: 255px">
				<%-- <option><%=rsid.getString("ColloectionStaffName")%></option> --%>
				<option value="<%=rsid.getString("ColloectionStaffName")%>"><%=rsid.getString("ColloectionStaffName")%></option>
		 <% String sqlDropdownCCB="SELECT Distinct name  FROM "+session.getAttribute("CompanyMasterID").toString()+"collectionStaffMaster order by name asc";
				  ...
				  while(rsDropdownCCB.next()){
				  %>
 <option value="<%=rsDropdownCCB.getString(1)%>"><%=rsid.getString("ColloectionStaffName")%></option>							
						<% 	}%> </select> </td>
		...
		<tr>
			...
			<td>
			<div id="comm"><input type="text" name="comm" onblur="myFunction()"  value="<%=rsid.getString("commission")%>"/></div>
			</td>
			
			<td  align="left"><font face="Arial" size="2" color="black"><b>Remarks :</b></font></td>
			<td>
			<%-- <div id="remark"><textarea id="remark" name="remark"  style="width: 400px" value="<%=rsid.getString("remark")%>"></textarea></div> --%>
			<div id="remark"><textarea id="remark" name="remark" style="width: 400px"><%=rsid.getString("remark")%></textarea></div>
			</td>
