...
function Redirect()
{
	    ...
	    location.assign("OPTaskDetailsReport.jsp?userId="+userId+"&fromdate="+dd+"&todate="+dd1+"&HOD="+HOD+"&Dept="+Dept+"&User="+Usern+"&Status="+Status+"&Role="+Role);
...
String usrid11=request.getParameter("usrid11");
System.out.println("usrid11 :- "+usrid11);

String tskid1=request.getParameter("Task1");
...
String dep=request.getParameter("Dept1");
String usr=request.getParameter("Usern1");
String rol=session.getAttribute("role").toString();
String stst=request.getParameter("Status1");

/*
System.out.println("userId1:"+usrid11);
System.out.println("Usern1:"+usr);
System.out.println("TaskID1:"+tskid1);
System.out.println("datenew1:"+datefrom);
System.out.println("datenew2:"+dateto);
System.out.println("Status1:"+stst);
System.out.println("HOD1:"+hod);
System.out.println("Dept1:"+dep);
System.out.println("Role1:"+rol);
*/
