...
try
	{
		...
		if(rs1.next()){
			...
			<jsp:forward page="alertGoTo.jsp">
			 <jsp:param name="msg" value="This Risk Is Already Exist  " ></jsp:param>
		...
		String compQuery="update "+session.getAttribute("CompanyMasterID").toString()+"riskInvolvedMaster set riskInvolved=?, description=?, EntryBy=?  where srno='"+ srno+"'";
		...
		response.sendRedirect("alertGoTo.jsp?msg=Risk Updated successfully&goto=riskInvMaster.jsp");
		}
}
catch(Exception e)
{
