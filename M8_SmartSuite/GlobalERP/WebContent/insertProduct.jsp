...
try
	{
		...
		String compQuery="insert into "+session.getAttribute("CompanyMasterID").toString()+"productMaster (product, description, EntryBy,status) values (?,?,?,?)";
		...
		response.sendRedirect("alertGoTo.jsp?msg=New Product Added Successfully&goto=productMaster.jsp");
		}
}
catch(Exception e)
{
