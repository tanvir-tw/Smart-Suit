...
<%@page import="java.util.Date"%>
 ...
 %> <%
		...
		try {
			...
			{}
 %> 
<form name="addBranch" method="post" action="insertFreightType.jsp" onsubmit="return ValidateForm();">
		<div align="center"><font face="Arial" color="black" size="3"><b>Add New Freight Type</b></font></div>
		<br><br>
		<table align="center">
			<tr>
				<td>
				...
				<td>
						<input type="text" name="frtType" id="frtType" onblur="return validateBranchName();" style="width: 300px;" />
				</td>
			</tr>
