...
try
	...
	System.out.println("remark"+remark);
		...
		String compQuery="update "+session.getAttribute("CompanyMasterID").toString()+"collectionStaffMaster set name=?, branch=?,contact=?, email=? , commission=?, location=?, validfrom=?, validto=?, remark=?,EntryBy=?  where srno='"+ srno+"'";
		...
		response.sendRedirect("alertGoTo.jsp?msg=Collection Staff Updated successfully&goto=collectionStaffReport.jsp");
