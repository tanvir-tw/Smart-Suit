...
try
	{
		...
		String compQuery="update db_GlobalERP.100015opportunitymaster set status='Deactivate' where srno='"+srno+"' limit 1";
		java.sql.PreparedStatement stmt = con.prepareStatement( compQuery );
		System.out.println("Query"+compQuery);
		stmt.executeUpdate(); 
		response.sendRedirect("alertGoTo.jsp?msg=Record Deactivated Successfully&goto=OpportunityReport.jsp");
...
catch(Exception e)
{
	...
	response.sendRedirect("alertGoTo.jsp?msg=Record not Deactivated. Please try again.&goto=OpportunityReport.jsp");
}
%>