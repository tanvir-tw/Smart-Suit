...
if(status.equals("All Prospect Entries"))
{
	status="All Prospect Entrie";
}
else
{
       status=status;
...
<font size="3"><b> <%=status %>s</b></font></td></tr>
<tr></tr>
</table>
<br><br><br>
...
<% 
if(status.equals("Assigned Prospect") || status.equals("Assigned Customer"))
{
%>
...
<% if(status.equals("Assigned Prospect"))
{
%>
<iframe id="myIframe" width="52.5%" height="500px" src="http://<%=host1 %>:8080/birt/frameset?__report=AssignedProspect.rptdesign&companyid=<%=companyid %>&__showtitle=false">
...
else if(status.equals("Assigned Customer"))
{
%>
<iframe id="myIframe" width="52.5%" height="500px" src="http://<%=host1 %>:8080/birt/frameset?__report=AssignedCustomerReport.rptdesign&companyid=<%=companyid %>&__showtitle=false">
	<!-- <iframe id="myIframe" width='100%' height='650px' src=""> -->
	</iframe>
<%} else if(status.equals("Missed Customer"))
{%>

<iframe id="myIframe" width="100%" height="500px" src="http://<%=host1 %>:8080/birt/frameset?__report=MissedCustomer.rptdesign&companyid=<%=companyid %>&__showtitle=false">
	<!-- <iframe id="myIframe" width='100%' height='650px' src=""> -->
	</iframe>
<%} else if(status.equals("Missed Prospect"))
{%>

<iframe id="myIframe" width="100%" height="500px" src="http://<%=host1 %>:8080/birt/frameset?__report=MissedProspect.rptdesign&companyid=<%=companyid %>&__showtitle=false">
	<!-- <iframe id="myIframe" width='100%' height='650px' src=""> -->
	</iframe>
<%} else if(status.equals("All Prospect Entrie"))
{%>

<iframe id="myIframe" width="100%" height="500px" src="http://<%=host1 %>:8080/birt/frameset?__report=All.rptdesign&companyid=<%=companyid %>&__showtitle=false">
	<!-- <iframe id="myIframe" width='100%' height='650px' src=""> -->
	</iframe>
<%} else if(status.equals("Prospect"))
{%>

<iframe id="myIframe" width="100%" height="500px" src="http://<%=host1 %>:8080/birt/frameset?__report=Prospect.rptdesign&companyid=<%=companyid %>&__showtitle=false">
	<!-- <iframe id="myIframe" width='100%' height='650px' src=""> -->
	</iframe>
<%} else if(status.equals("Customer"))
{%>

<iframe id="myIframe" width="100%" height="500px" src="http://<%=host1 %>:8080/birt/frameset?__report=Customer.rptdesign&companyid=<%=companyid %>&__showtitle=false">
	<!-- <iframe id="myIframe" width='100%' height='650px' src=""> -->
	</iframe>
<%} %>
