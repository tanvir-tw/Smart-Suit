...
<%@page import="java.util.Date"%>
	...
	<title>Add New Risk Involved</title>
	</head>
 ...
 %> <%
		...
		try {
			...
			{}
 %> 
<form name="addBranch" method="post" action="insertRisk.jsp" onsubmit="return ValidateForm();">
		<div align="center"><font face="Arial" color="black" size="3"><b>Add New Risk</b></font></div>
		<br><br>
		<table align="center">
			<tr>
				<td>
				...
				<td>
						<input type="text" name="risk" id="risk" onblur="return validateBranchName();" style="width: 300px;" />
				</td>
			</tr>
