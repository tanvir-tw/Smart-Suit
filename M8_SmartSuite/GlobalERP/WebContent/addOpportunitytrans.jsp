...
<!-- Script by hscripts.com -->
		...
		<tr>
			...
			<select name="category" style="
				  ...
				  <% String sqlDropdown="SELECT TheGroupName,TheGroupCode FROM "+session.getAttribute("CompanyMasterID").toString()+"tbl_groupmaster order by TheGroupName";
		...
		<td>&nbsp;<b>Currency</b></td>
				   <td>
				   <select name="currency" id="currency" style='width: 220px; height: auto;'>
				  	<option value="Select">Select</option>
				  <% String sqlDropdown2="select CurrencyType,CurrencyValue from "+session.getAttribute("CompanyMasterID").toString()+"currencydet order by CurrencyType asc";
				  ResultSet rsDropdown2=st4.executeQuery(sqlDropdown2);
				  while(rsDropdown2.next()){
					 
						  %>
						   <option value="<%=rsDropdown2.getString("CurrencyValue") %>"><%=rsDropdown2.getString("CurrencyType")%></option>
						  <%
					  	}%> 
				</select>
				</td>
		...
		<tr>
			<td  align="left"><font face="Arial" size="2" color="black"><b>Potential Value :</b></font></td>
			<td>
			<div id="potentialValue"><input type="text" name="potentialValue" onblur="validCurrency()"/></div>
				   </td>
	...
	<br>
          	<br>
	<div id="footer" style="float:left;width:100%"><p>
<<a href="#">
Copyright &copy; Transworld Technologies Ltd.
</a></p>
</div></div>
	<!-- end #footer -->
	</body>
