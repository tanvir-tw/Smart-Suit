...
System.out.println("\n>>>>>$$$$$$$$$$$$$>>>In AjaxCanceleTransaction.jsp>>>>>>>>>>>>>>>>"+con1);	
...
for(int i=1;i<arr.length;i++)
	{
		...
		SqlUpdate="UPDATE  "+session.getAttribute("CompanyMasterID").toString()+"netbankingrecords SET RecordStatus ='Canceled' , ApprovalComments='"+arr1[j]+"',ApprovedBy='"+user+"',ApprovedDateTime='"+todaysDateTime+"' WHERE ID='"+arr[i]+"' limit 1 ";
...
System.out.println("AjaxCancelTransaction.jsp error  table > "+e);
out.println("NO");
} finally {
	con1.close();
