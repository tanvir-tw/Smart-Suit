<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <%@ page import="org.apache.commons.fileupload.*" import="java.util.*"
 ...
 */
    ...
    location.assign("OPTaskDetailsReport.jsp?userId="+userId+"&fromdate="+dd+"&todate="+dd1+"&HOD="+HOD+"&Dept="+Dept+"&User="+Usern+"&Status="+Status+"&role="+Role+"&itemName2="+itemName2+"");
...
public static void updateTaskStatus(int taskId, int statusId, int percentageDone) {
    ...
    try {
		...
		System.out.println("work_packages update payload-->"+payload);
...
public static void logTimeEntry(int taskId, String hours, String comment, String spentOn) {
    ...
    try {
        ...
        System.out.println("time_entries update payload-->"+payload);
...
if(rs.next())
  ...
  //   System.out.println("Task Users Dept  :- "+department);
      ...
      //System.out.println("User1:"+User1);
        ...
        // Update the task's status and percentage done
        //System.out.println("calling updateTaskStatus("+taskId+","+statusId+","+percentageDone+")");
        updateTaskStatus(taskId, statusId, percentageDone);

       // System.out.println("calling logTimeEntry("+taskId+","+spentTime+","+comment1+","+spentOn+")");
        // Log the spent time
...
<input type="hidden" name="Dept1" id="Dept1" value="<%=Dept%>" /></input>                                                                   <input type="hidden" name="Usern1" id="Usern1" value="<%=Usern%>" /></input>   
