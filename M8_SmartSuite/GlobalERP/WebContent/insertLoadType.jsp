...
try
	{
		...
		String sql="select * from "+session.getAttribute("CompanyMasterID").toString()+"loadTypeMaster where loadType='"+loadType+"' ";
		...
		String compQuery="insert into "+session.getAttribute("CompanyMasterID").toString()+"loadTypeMaster (loadType, description, EntryBy,status) values (?,?,?,?)";
		...
		response.sendRedirect("alertGoTo.jsp?msg=New Load Type Added Successfully&goto=loadTypeMaster.jsp");
		}
}
catch(Exception e)
{
