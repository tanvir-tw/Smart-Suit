...
String datex1="",datex2="",bt="",data1="",data2="",dt="",dt1="",dttime="",dt1time="",dropdownVal="";
...
bt=request.getParameter("button");
	...
	if (bt== null || bt.equals("null")) {		
		...
		dropdownVal = request.getParameter("data1");
...
<div class="content-header-col-md-7-mt-10 col-12">
  ...
  <form name="formreport" id="formreport" method="post">
		    <div class="row col-12">
			 ...
			 <div class="col-md-3">
                <label for="input"><b>Input(Ajax)</b></label>
                <input class="form-control form-control-sm" type="text" id="input" name="input" placeholder="Enter Input">
