...
<%@page import="java.util.Date"%>
	...
	<title>Add New Freight Type</title>
	</head>
	<script type="text/javascript">
	function ValidateForm()
	{
			var frtType=document.addBranch.frtType.value;
			if(frtType=="")
			{
				alert("Please Enter Freight Type");
				return false;
			}
 ...
 %> <%
		...
		String frtType="", description="";
		String Query="Select * from "+session.getAttribute("CompanyMasterID").toString()+"freightMaster where srno='"+srno+"'";
		 ResultSet rs = st.executeQuery(Query);
		while(rs.next())	
		{
			frtType=rs.getString("frtType");
			description=rs.getString("description");
			
		}
 %> 
<form name="addBranch" method="post" action="insertEditFreightType.jsp?Id=<%=srno%>" onsubmit="return ValidateForm();">
		<div align="center"><font face="Arial" color="black" size="3"><b>Edit Existing Freight Type</b></font></div>
		<br><br>
		<table align="center">
			<tr>
				<td>
						<font face="Arial" size="2" color="black"><b>Freight Type</b></font>&nbsp;&nbsp;<font size="2" color="red">*</font>
				</td>
				<td>
						<input type="text" name="frtType" id="frtType" value="<%=frtType %>" onblur="return validateBranchName();" style="width: 300px;" />
				</td>
			</tr>
