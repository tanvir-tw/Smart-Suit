...
idnew=request.getParameter("cont_id");


System.out.println("Old ID:--------------->"+id);
System.out.println("New ID:--------------->"+idnew);
		...
		String TempAddr=""+tempadd1+","+tempadd2+","+Tempcity+","+tempzip+","+tempcon+","+tempstate;		
		 ...
		 Statement stsms=con.createStatement();
	        ...
	        if(idnew.equals(id))
	        {
	        	 ...
	        	 sqlInsert="update db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"ContractMasterNew set ContractorName='"+name+"',CompanyName='"+cmpname+"',PermanentAddress='"+PermAddr+"',TemporaryAddress='"+TempAddr+"',MobNo='"+phn+"',Email='"+prnsemail+"',ImmediateContactName='"+immname+"',ImmediateContactRelation='"+rel+"',ImmediateContactNumber='"+immphn+"',DateOfBirt='"+dob+"',MaritalStatus='"+Marrital+"',PanCard='"+pan+"',AadharCard='"+aadhar+"',DrivingLicense='"+driving+"',Passport='"+passport+"',BankName='"+bnkname+"',BankAccountNumber='"+accno+"',BankAccountHolder='"+accname+"',BankIFSCCode='"+ifsc+"',BankBranchName='"+branch+"',MediclaimPolicyNo='"+policyno+"',MediclaimCompanyName='"+medicmp+"',MediclaimStartDate='"+dt1+"',MediclaimEndDate='"+dt2+"',Education='"+edu+"',Stream='"+strm+"',EntryBy='"+EntryBy+"',EntryDate='"+EntryDate+"' where ContractorId='"+id+"' and CompanyName='"+cmpname+"'"; 
	 	        System.out.println("Update :::::::: "+sqlInsert);

	        }
	        else
	        {
	        	
	        	String checkid="select * from db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"ContractMasterNew where ContractorId='"+idnew+"' and CompanyName='"+cmpname+"'";
	        	ResultSet rs12=st6.executeQuery(checkid);
	        	
	        	if(rs12.next())
	        	{
	        		out.println("<script type=\"text/javascript\">");
		               out.println("swal('Contractor Id Already Present ','','success');");
	        	...
	        	{
	        		sqlInsert="update db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"ContractMasterNew set ContractorId='"+idnew+"',ContractorName='"+name+"',CompanyName='"+cmpname+"',PermanentAddress='"+PermAddr+"',TemporaryAddress='"+TempAddr+"',MobNo='"+phn+"',Email='"+prnsemail+"',ImmediateContactName='"+immname+"',ImmediateContactRelation='"+rel+"',ImmediateContactNumber='"+immphn+"',DateOfBirt='"+dob+"',MaritalStatus='"+Marrital+"',PanCard='"+pan+"',AadharCard='"+aadhar+"',DrivingLicense='"+driving+"',Passport='"+passport+"',BankName='"+bnkname+"',BankAccountNumber='"+accno+"',BankAccountHolder='"+accname+"',BankIFSCCode='"+ifsc+"',BankBranchName='"+branch+"',MediclaimPolicyNo='"+policyno+"',MediclaimCompanyName='"+medicmp+"',MediclaimStartDate='"+dt1+"',MediclaimEndDate='"+dt2+"',Education='"+edu+"',Stream='"+strm+"',EntryBy='"+EntryBy+"',EntryDate='"+EntryDate+"' where ContractorId='"+id+"' and CompanyName='"+cmpname+"'"; 
		 	        System.out.println("Update :::::::: "+sqlInsert);	
	        	}
	       ...
	       sqlst= stsms.executeUpdate(sqlInsert);
	        ...
	        {
	            out.println("<script type=\"text/javascript\">");
	            out.println("alert('Update Seccessfull','','success');");
