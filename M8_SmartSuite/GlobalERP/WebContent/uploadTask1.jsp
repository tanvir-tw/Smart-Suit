...
String TaskList_FilePath = System.getenv("TaskList_FilePath");
String TaskListDestination = System.getenv("TaskListDestination_FilePath");

System.out.println("TaskList_File Path : " +TaskList_FilePath);
System.out.println("TaskListDestination_FilePath : "+ TaskListDestination);
		                        ...
		                        if(name1.equals("uploadedby")) 
		                        {
                                   ...
                                   try {
                                        ...
                                        else
                                         {
                                     		...
                                     		savedFile = new File(TaskList_FilePath+itemName);  
...
try{	   
        		...
        		try {
						...
						String MM_dbConn_USERNAME = user2;
						String MM_dbConn_PASSWORD = pass;
					//	String MM_dbConn_GPS = "jdbc:mysql://192.168.2.55/dotproject";  
						String MM_dbConn_GPS = "jdbc:mysql://"+host+"/dotproject";
					  //String MM_dbConn_GPS = "jdbc:mysql://154.12.230.205/dotproject";//means 138*******
				...
				//	String fname = "/home/sumedh/Desktop/Task_List/"+file1;
					String fname = TaskList_FilePath+file1;
       		...
       		// Iterates the data and print it out to the console.	
			        for (int i = 1; i < sheetData.size(); i++) {
			               ...
			               System.out.println( "The cell type is :"+cell.getCellType());	
			                ...
			                if (cell.getCellType() == CellType.NUMERIC) {
			                    ...
			                    if (DateUtil.isCellDateFormatted(cell)) {
			                        ...
			                        String numValue = new BigDecimal(cell.getNumericCellValue()).toString();
						...
						//	String maxid = "Select max(task_id) as maxID from dotprojectfortesting.tasks";
							...
							System.out.println("countFeildlllllllllllllllllllllllllllllllllllll"+ countFeild);
						try{	
							if(countFeild == 8)
							{							
								cnt++;
							...
							{	cnt++;
								String sql ="insert into dotproject.tasks(task_id,task_name,task_parent,task_project,task_owner,task_start_date,task_duration,task_end_date,task_description,task_creator)values('"+newtaskid+"','"+task+"','"+newtaskid+"','"+project+"','"+userid+"','"+frmDate+"','"+task_duration+"','"+toDate+"','"+task+"','"+userid+"')";
								System.out.println("The query is :"+sql);
								st.execute(sql);
			...
			//     File f = new File("/home/javaprg/TaskList/"+file1);	
			     File f = new File(TaskList_FilePath,file1);	
				if(f.renameTo(new File(TaskList_FilePath + file1)))			    
				{							
	...
	System.out.println("Th exception is >>>>>"+e);  //poonam test for commit
