...
<script>
	function getcheckedrow() {
		...
		window.location = "OPActionApprovedTask.jsp?action=approve&id=" + id + "";
	...
	function getcheckedrow1() {
       ...
       // alert(values); 
		...
		//window.location = "OPActionApprovedTask.jsp.jsp?action=reject&id=" + id + "&rejcomment=" + values + "";
		//window.location="OPActionApprovedTask.jsp.jsp?action=&id="+id+"&rejcomment="+rejcomment+"";
		 window.location = "OPActionApprovedTask.jsp?action=reject&id=" + id + "&rejcomment=" + values + "&indxtype="+indxtype+"&dept="+Sdept+"&ename="+ename+"&frdate="+frdate+"&todate="+todate;
	}
</script>
</head>
<body>
...
<table align="center" width="100%">
	<tr align="center">
		<td align="center">
			...
			<font size="3" color="black"><b>Rejected Task Report</b></font>
		</td>
	</tr>
</table>
<br>
	...
	<table width="100%" border="1" align="center" class="sortable">
		...
		<%
			...
			for (int i = 1; i < arr.length; i++) {
				...
				String sql_total = "select * from db_GlobalERP."+session.getAttribute("CompanyMasterID").toString()+"taskmaildataCopy where TaskID='" + arr[i]
						+ "' limit 1";
